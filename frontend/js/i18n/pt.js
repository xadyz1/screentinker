...
export default {
  ...
  'device.tier2.tip': 'Controlos avançados disponíveis porque esta TV está em modo Device Owner',
  'device.tier2.reboot': 'Reiniciar (Reboot)',
  'device.tier2.reboot_confirm': 'Reiniciar esta TV agora?',
  'device.tier2.lock': 'Bloquear ecrã',
  'device.tier2.kiosk_on': 'Ligar Quiosque',
  'device.tier2.kiosk_off': 'Desligar Quiosque',
  ...
  'widget.rollover.messages_label': 'Mensagens',
  'widget.rollover.add_msg': 'Adicionar Mensagem',
  'widget.rollover.duration_label': 'Duração (s)',
  'widget.rollover.effect_label': 'Transição',
  'widget.rollover.effect_fade': 'Desvanecer (Fade)',
  'widget.rollover.effect_slide': 'Deslizar (Slide)',
  'widget.rollover.align': 'Alinhamento',
  'widget.menu.title': 'Título do Menu',
  'widget.menu.currency': 'Símbolo de Moeda',
  'widget.menu.sections': 'Secções do Menu',
  'widget.prop.properties': 'Imóveis',
